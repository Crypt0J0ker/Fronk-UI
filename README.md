...
```
cd existing_repo
git remote add origin https://gitlab.competentit.ru/fronk-world/project-quests/web.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.competentit.ru/fronk-world/project-quests/web/-/settings/integrations)
